...
//            throw new IllegalStateException("CheckView is not countable, call setChecked() instead.");
            setChecked(checkedNum != UNCHECKED);
            return;
        }
...
//                                    Color.parseColor("#0D000000"), Color.parseColor("#00000000")},
                            new int[]{Color.TRANSPARENT, Color.parseColor("#20000000"),
                                    Color.parseColor("#20000000"), Color.TRANSPARENT},
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            mBackgroundPaint.setColor(getContext().getResources().getColor(R.color.colorPrimary));
        }
    }
