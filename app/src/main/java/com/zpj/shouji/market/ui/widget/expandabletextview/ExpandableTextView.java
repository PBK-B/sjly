...
//                    }, ssb.length() - mContractString.length() - expendLength, ssb.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
                    ssb.setSpan(new Clickable(mContractTextColor) {
                        @Override
                        public void onClick(View widget) {
                            if (mModel != null) {
                                mModel.setStatus(StatusType.STATUS_EXPAND);
...
//        }, data.getStart(), endPosition, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        ssb.setSpan(new Clickable(mSelfTextColor) {
            @Override
            public void onClick(View widget) {
                if (linkClickListener != null)
                    linkClickListener.onLinkClickListener(LinkType.SELF, data.getSelfAim(), data.getSelfContent());
...
//            }
//        }, data.getStart(), endPosition, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        ssb.setSpan(new Clickable(mMentionTextColor) {
            @Override
            public void onClick(View widget) {
                if (linkClickListener != null)
                    linkClickListener.onLinkClickListener(LinkType.MENTION_TYPE, data.getUrl(), null);
...
//            }
//        }, data.getStart(), endPosition, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        ssb.setSpan(new Clickable(mLinkTextColor) {
            @Override
            public void onClick(View widget) {
                if (linkClickListener != null)
                    linkClickListener.onLinkClickListener(LinkType.TOPIC_TYPE, data.getUrl(), null);
...
//        Pattern pattern = Pattern.compile(regexp, Pattern.CASE_INSENSITIVE);
    ...
    private static abstract class Clickable extends ClickableSpan {

        public int textColor;

        private boolean mIsPressed;

        public Clickable(int textColor) {
...
//                    mPressedSpan.setIsPressed(true);
...
//                Clickable touchedSpan = getPressedSpan(widget, buffer, event);
//                if (mPressedSpan != null && touchedSpan != mPressedSpan) {
//                    mPressedSpan.setIsPressed(false);
//                    mPressedSpan = null;
//                    Selection.removeSelection(buffer);
//                }
//            } else {
...
//            return Touch.onTouchEvent(widget, buffer, event);
            ...
            Log.d("LocalLinkMovementMethod", "onTouchEvent action=" + MotionEvent.actionToString(action));
            if (action == MotionEvent.ACTION_UP ||
...
//                int off = layout.getOffsetForHorizontal(line, x);
//
//                Clickable[] link = buffer.getSpans(
//                        off, off, Clickable.class);
//
//                Log.d("LocalLinkMovementMethod", "onTouchEvent link.length=" + link.length);
//                if (link.length != 0) {
//                    Log.d("LocalLinkMovementMethod", "onTouchEvent link[0]=" + link[0]);
//                    if (action == MotionEvent.ACTION_UP) {
//                        link[0].onClick(widget);
//                        link[0].setIsPressed(false);
//                    } else if (action == MotionEvent.ACTION_DOWN) {
//                        link[0].setIsPressed(true);
//                        Selection.setSelection(buffer,
...
//                }
//            } else {
//                Clickable clickable = getPressedSpan(widget, buffer, event);
//                if (clickable != null) {
//                    clickable.setIsPressed(false);
//                }
//            }
//            return Touch.onTouchEvent(widget, buffer, event);
